...
package nzilbb.annotator.jython.test;
...
import nzilbb.annotator.jython.JythonAnnotator;

public class TestJythonAnnotator {
  static JythonAnnotator annotator = new JythonAnnotator();
  ...
  public static File dir() throws Exception { 
    URL urlThisClass = TestJythonAnnotator.class.getResource(
      TestJythonAnnotator.class.getSimpleName() + ".class");
  ...
  public static void main(String args[]) {
    org.junit.runner.JUnitCore.main("nzilbb.annotator.jython.TestJythonAnnotator");
  }
}
