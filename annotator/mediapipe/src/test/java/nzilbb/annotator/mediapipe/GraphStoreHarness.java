...
public class GraphStoreHarness implements GraphStore {
  ...
  public MediaFile saveMedia(String id, String mediaUrl, String trackSuffix)
    ...
    try {
      this.file = new File(new URI(mediaUrl));
    } catch(java.net.URISyntaxException exception) {
      throw new StoreException(exception);
    }
    return new MediaFile(this.file, this.trackSuffix);
  }
  ...
  public int deleteMatchingAnnotations(String expression)
    throws StoreException, PermissionException {
    throw new StoreException("deleteMatchingAnnotations Not implemented");
  }
  ...
  public String[] aggregateMatchingAnnotations(String operation, String expression)
    throws StoreException, PermissionException {
    throw new StoreException("aggregateMatchingAnnotations not supported");
  }

  public int tagMatchingAnnotations(
    String expression, String layerId, String label, Integer confidence) 
    throws StoreException, PermissionException {
    throw new StoreException("tagMatchingAnnotations not supported");
  }  
  ...
  public Schema getSchema()
    ...
    return new Schema(
      ...
      new Layer("unisyn", "Unisyn").setAlignment(Constants.ALIGNMENT_NONE)
      .setPeers(true).setPeersOverlap(true).setSaturated(true)
      .setParentId("word").setParentIncludes(true),
