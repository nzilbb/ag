...
| --- | :---: | :---:  | :---: | :---: | :---: | :---: |
| **trs** | | [trs-to-eaf.jar](trs-to-eaf.jar?raw=true) | [trs-to-textgrid.jar](https://github.com/nzilbb/ag/blob/master/bin/trs-to-textgrid.jar?raw=true) | [trs-to-vtt.jar](https://github.com/nzilbb/ag/blob/master/bin/trs-to-vtt.jar?raw=true) | [trs-to-pdf.jar](https://github.com/nzilbb/ag/blob/master/bin/trs-to-pdf.jar?raw=true) | [trs-to-txt.jar](https://github.com/nzilbb/ag/blob/master/bin/trs-to-txt.jar?raw=true) |
