...
public class TestDISC2XSAMPA2DISC {
  ...
  @Test public void maus() throws Exception {
    XSAMPA2DISC xsampa2disc = new XSAMPA2DISC();
    assertEquals("MAUSBasic en-AU diphthongs",
                 "1@526QL", xsampa2disc.apply("{I 6: @} Ae {Q O 4"));

    assertEquals("maus-sampa - saved",
                 "s1vd", xsampa2disc.apply("s{Ivd"));
    assertEquals("maus-sampa - up",
                 "@p", xsampa2disc.apply("6p"));
    assertEquals("maus-sampa - property",
                 "prQp@Li", xsampa2disc.apply("prOp@4i:"));
  }  
