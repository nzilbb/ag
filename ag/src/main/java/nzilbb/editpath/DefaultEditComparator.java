...
/**
 * Default implementation of IEditComparator, for which any from/to pair for which
 * equals() is not true is given an edit distance of {@link #getChangeDistance()}. 
 * @author Robert Fromont robert@fromont.net.nz
 */
public class DefaultEditComparator<T> implements EditComparator<T> {
  // Attributes:
  ...
  /**
   * Getter for {@link #comparator}: A comparator to use to determin equality, or null to
   * use java.util.Object.equals(Object). 
   * @return A comparator to use to determin equality, or null to use
