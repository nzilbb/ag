...
public class MediaFile implements CloneableBean {
  ...
  /**
   * Getter for {@link #trackSuffix}: The track suffix of the media 
   * - see {@link MediaTrackDefinition#suffix}.
   * @return The track suffix of the media - see {@link MediaTrackDefinition#suffix}.
   */
  @ClonedProperty
  public String getTrackSuffix() { return trackSuffix; }
  /**
   * Setter for {@link #trackSuffix}: The track suffix of the media 
   * - see {@link MediaTrackDefinition#suffix}.
   * @param newTrackSuffix The track suffix of the media 
   * - see {@link MediaTrackDefinition#suffix}. 
   */
  ...
  /**
   * Getter for {@link #generateFrom}: The media file from which this one could be
   ...
   * generated, or null if the file already exists. 
   * @param newGenerateFrom The media file from which this one could be generated, or null
   ...
   * @return The top-level type of the file, based on the MIME type - i.e. "audio",
  ...
  public static Map<String,String> SuffixToMimeType() {
    if (mSuffixToMimeType == null) {
      ...
      mSuffixToMimeType.put("wma", "audio/x-ms-wma");
  ...
  public static Map<String,String> MimeTypeToSuffix() {
    if (mMimeTypeToSuffix == null) {
      ...
      mMimeTypeToSuffix.put("audio/x-ms-wma", "wma");
