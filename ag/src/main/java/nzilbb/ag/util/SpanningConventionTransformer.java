 ...
 */
public class SpanningConventionTransformer implements GraphTransformer {  // TODO implementation that handles nested extraction, for phrase structure
  // Attributes:
   ...
   */
  public SpanningConventionTransformer(
    String sourceLayerId, String startPattern, String endPattern, boolean deleteInSource,
    String sourceStartResult, String sourceEndResult, String destinationLayerId,
    String delimiter, String destinationStartResult, String destinationEndResult) {
  ...
  public SpanningConventionTransformer(
    String sourceLayerId, String startPattern, String endPattern, boolean deleteInSource,
    String sourceStartResult, String sourceEndResult, String destinationLayerId,
    String destinationStartResult, String destinationEndResult) {
    setSourceLayerId(sourceLayerId);
    setStartPattern(startPattern);
    setEndPattern(endPattern);
    setDeleteInSource(deleteInSource);
  ...
  public SpanningConventionTransformer(
    String sourceLayerId, String startPattern, String endPattern, boolean deleteInSource,
    String sourceStartResult, String sourceEndResult,
    String destinationLayerId, String destinationStartResult, String destinationEndResult,
    boolean annotatePrevious) {
    setSourceLayerId(sourceLayerId);
    setStartPattern(startPattern);
    setEndPattern(endPattern);
  ...
  public SpanningConventionTransformer(
    String sourceLayerId, String startPattern, String endPattern, boolean deleteInSource,
    String sourceStartResult, String sourceEndResult,
    String destinationLayerId, String destinationStartResult,
    String destinationEndResult, boolean annotatePrevious, boolean closeGaps) {
    setSourceLayerId(sourceLayerId);
    setStartPattern(startPattern);
    setEndPattern(endPattern);
    setDeleteInSource(deleteInSource);
    ...
    try {
      ...
      for (Annotation parent : graph.all(graph.getLayer(getSourceLayerId()).getParentId())) {
        ...
        for (Annotation source : parent.annotations(getSourceLayerId())) {
          ...
          if (span != null) { // in a span
            span.add(source);
            // look for end
            Matcher endMatcher = endRegexp.matcher(source.getLabel());
            if (endMatcher.matches()) { // found the end of the span
