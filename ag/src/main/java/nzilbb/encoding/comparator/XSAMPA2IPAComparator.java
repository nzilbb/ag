 ...
 */
public class XSAMPA2IPAComparator<E> implements EditComparator<E> {

  XSAMPA2DISC asDISC = new XSAMPA2DISC();
  ...
  public EditStep<E> compare(E from, E to) {
    ...
    if (from == null || from.toString().length() == 0) {
      ...
      EditStep<String> ipaStep = ipa2ipaComparator.compare(
        asIPA.apply(asDISC.apply(from.toString())), to.toString());
