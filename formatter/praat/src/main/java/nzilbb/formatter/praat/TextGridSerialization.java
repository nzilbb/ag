...
public class TextGridSerialization
   ...
   public SerializationDescriptor getDescriptor() {
      return new SerializationDescriptor(
         "Praat TextGrid", getClass().getPackage().getImplementationVersion(),
         "text/praat-textgrid", ".textgrid", "20200909.1954",
   ...
   public ParameterSet load(NamedStream[] streams, Schema schema)
      ...
      } catch (Throwable t) { // if that doesn't work, try utf...
         reset();
         try {
            ByteBuffer bytes = ByteBuffer.wrap(oBytes.toByteArray());	    
   ...
   public Graph[] deserialize() 
      ...
      for (Annotation a : graph.getAnnotationsById().values()) {
         ...
         if (a.getParentId() == null) { // parent STILL not set
