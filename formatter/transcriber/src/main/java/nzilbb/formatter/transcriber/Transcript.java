 ...
 * document, including speakers, topics, sections, turns, etc. 
...
public class Transcript {
  ...
  /**
   * AudioFilename accessor - Name of the WAV (or other media) file to which the
  ...
  /**
   * AudioFilename mutator - Name of the WAV (or other media) file to which the
   * transcript corresponds 
   * @param sNewAudioFilename Name of the WAV (or other media) file to which the
   * transcript corresponds 
   */
  ...
  /**
   * VersionDate accessor - The date of this version of the transcript, as generated by
   * Transcriber 
  ...
  /**
   * VersionDate mutator - The date of this version of the transcript, as generated by
   * Transcriber 
   * @param sNewVersionDate The date of this version of the transcript, as generated by
   * Transcriber 
   */
  ...
  /**
   * Sections of this transcript (A list of {@link Section} objects).
   */
  protected Vector<Section> vSections = new Vector<Section>();
  /**
   * Sections accessor
   * @return Sections of this transcript (A list of {@link Section} objects)
   */
   ...
   * @return A Vector of Turn objects (A list of * {@link Turn} objects) 
   */
  ...
  /**
   * Speakers that appear in the transcript - a Hashtable of {@link Speaker} objects
   * keyed on SpeakerId  
   */
   ...
   * @return A collection of all {@link Word} objects in the transcript, in order.  They
   * are returned in the order determined by  {@link Sync#getWords()} (so in the case of
   * simultaneous speech, the words are sequentially but grouped by speaker).
   */
  ...
  /**
   * Check the structure of the transcript is valid. For example, there must be no
   * simultaneous-speech turns where both speakers are actually the same speaker. 
   * @return Vector of String objects, each being an error message, or null if there are
   * no errors. 
   */
