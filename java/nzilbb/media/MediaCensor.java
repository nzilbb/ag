 ...
 * between them. 
 * <p>The method of obfuscation is implementation dependent (e.g. silence or low-pass
 * filter for audio, or blacking out or pixellation for video), but the result should be a
 * media file of the same type and same length.
...
public interface MediaCensor {
    ...
    *      media from 0.0-1.0 will be obfuscated, from 1.0-2.0 will be uncensored, and from 2.0
    *      onward will be obfuscated.</li> 
    * </ul>
    * @param sourceType The MIME type of the source media.
