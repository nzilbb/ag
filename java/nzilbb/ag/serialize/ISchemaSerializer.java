...
public interface ISchemaSerializer
{
   ...
   *  {@link ISchemaSerializer#getRequiredLayers()} can be called. If this is an empty list,
   *  {@link ISchemaSerializer#getRequiredLayers()} can be called. If it's not an empty list,
