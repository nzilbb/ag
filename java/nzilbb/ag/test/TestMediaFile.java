...
{      
   ...
   @Test public void toJson() {
      ...
      assertEquals("_mic", json.get("trackSuffix").toString());
      assertEquals("audio/wav", json.get("mimeType").toString());
      assertEquals("https://somewhere/something.wav", json.get("url").toString());
      assertEquals("Audio", json.get("name").toString());
   }

   public static void main(String args[]) {
      org.junit.runner.JUnitCore.main("nzilbb.ag.test.TestMediaFile");
   }
}
