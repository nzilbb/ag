 ...
 * of an edit operation having both {@link EditStep#getStepDistance()} = 0 and {@link EditStep#getOperation()} is set to either <var>EditStep.StepOperation.CHANGE</var>.  This allows for non-equal elements to have zero distance, but still preserve the fact of their inequality.
