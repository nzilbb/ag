...
public class TestEditStep
{
   ...
   public void constructor()
   {
      ...
      assertEquals(0, step0.getStepDistance());
   ...
   @Test 
   public void stepVsTotalDistance()
   {
      EditStep<Integer> step1 = new EditStep<Integer>(1,1,0,EditStep.StepOperation.NONE);
      ...
      assertEquals(0, step1.getStepDistance());
      assertEquals(0, step1.totalDistance());

      assertEquals(0, step2.getStepDistance());
      assertEquals(0, step2.totalDistance());

      assertEquals(100, step3.getStepDistance());
      assertEquals(100, step3.totalDistance());

      assertEquals(50, step4.getStepDistance());
      assertEquals(150, step4.totalDistance());

      assertEquals(25, step5.getStepDistance());
      assertEquals(175, step5.totalDistance());

      assertEquals(0, step6.getStepDistance());
      assertEquals(175, step6.totalDistance());

   }
   
   public static void main(String args[]) 
   {
      org.junit.runner.JUnitCore.main("nz.ac.canterbury.ling.util.test.TestEditStep");
   }
}
