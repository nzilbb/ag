 ...
 * of an edit operation having both {@link EditStep#getStepDistance()} = 0 and 
 * {@link EditStep#getOperation()} is set to either <var>EditStep.StepOperation.CHANGE</var>.
 * This allows for non-equal elements to have zero distance, but still preserve the fact
 * of their inequality. 
 * @author Robert Fromont robert@fromont.net.nz
 */
public interface EditComparator<T> {
   /**
    ...
    * EditStep#getStepDistance()} is set to the computed edit distance between these two
    ...
    * deleting the given element. {@link EditStep#getFrom()} is set to <var>from</var>,
    * and {@link EditStep#getOperation()} is set to
    * <var>EditStep.StepOperation.DELETE</var> 
    */
