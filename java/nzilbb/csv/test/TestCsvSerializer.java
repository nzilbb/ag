...
{      
   ...
   @Test public void ignoreConfidence() 
      throws Exception
   {
   ...
   @Test public void withAttributes() 
      throws Exception
   {
   ...
   @Test public void multipleLayers() 
      throws Exception
   {
   ...
   {
      org.junit.runner.JUnitCore.main("nzilbb.ag.serialize.csv.test.TestCsvSerializer");
   }
}
