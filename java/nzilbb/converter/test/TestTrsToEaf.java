...
import java.io.File;
import nzilbb.converter.TrsToEaf;

public class TestTrsToEaf extends UnitTestBase {
   
   @Test public void transcriber() throws Exception {
      File dir = getDir();
      File input = new File(dir, "transcriber.trs");
      TrsToEaf converter = new TrsToEaf();
   ...
   public static void main(String args[]) {
      org.junit.runner.JUnitCore.main("nzilbb.converter.test.TestTrsToEaf");
   }
}
