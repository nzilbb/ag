...
import java.io.File;
import nzilbb.converter.TrsToTextGrid;

public class TestTrsToTextGrid extends UnitTestBase {
   
   @Test public void transcriber() throws Exception {
      File dir = getDir();
      File input = new File(dir, "transcriber.trs");
      TrsToTextGrid converter = new TrsToTextGrid();
   ...
   public static void main(String args[]) {
      org.junit.runner.JUnitCore.main("nzilbb.converter.test.TestTrsToTextGrid");
   }
}
