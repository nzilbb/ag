...
/**
 * Converts WebVTT subtitle files to Transcriber transcript.
 * @author Robert Fromont robert@fromont.net.nz
 */
@ProgramDescription(value="Converts WebVTT subtitle files to Transcriber transcripts (.trs)",arguments="file1.vtt file2.vtt ...")
public class VttToTrs extends Converter {
