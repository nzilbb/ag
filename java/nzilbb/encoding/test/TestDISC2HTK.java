...
public class TestDISC2HTK {
   
   @Test public void DISC2HTK() throws Exception {
	 ...
	 "Z", /* <-> */"Z"
      ...
      DISC2HTK translator = new DISC2HTK();
      assertEquals("Source encoding name", "DISC", translator.getSourceEncoding());
      assertEquals("Destination encoding name", "HTK", translator.getDestinationEncoding());
	 ...
	 sHTK.append(aCodebook[i+1]);
      ...
      assertEquals(translator.apply(sDISC.toString()), sHTK.toString());      
   }
...
//	 "9", /* <-> */"U@", // CURE
	 ...
	 sHTK.append(aCodebook[i+1]);
      ...
      // suprasegmentals
      assertEquals("suprasegments removed",
		   "m _ʌ t n̩ t͡ʃ _ɔ p s", translator.apply("ˈmʌt.n̩.ˌt͡ʃɔps"));

      // DISC ʤ
      assertEquals("DISC ʤ",
		   "__ V __", translator.apply("_V_"));

   }

   public static void main(String args[]) {
      org.junit.runner.JUnitCore.main("nzilbb.encoding.test.TestDISC2HTK");
   }
}
