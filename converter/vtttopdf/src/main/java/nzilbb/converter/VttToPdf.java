 ...
 */
@ProgramDescription(value="Converts WebVTT subtitle files to PDF documents",arguments="file1.vtt file2.vtt ...")
public class VttToPdf extends Converter {
