...
public class TestTrsToCha {
  ...
  @Test public void convert() throws Exception {
    File dir = getDir();
    File input = new File(dir, "mop03-2b.trs");
    TrsToCha converter = new TrsToCha();
 ...
 /**
  ...
  public static void main(String args[]) {
    org.junit.runner.JUnitCore.main("nzilbb.converter.TestTrsToCha");
  }
}
