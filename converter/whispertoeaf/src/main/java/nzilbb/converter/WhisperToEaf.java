...
/**
 * Converts Whisper ASR's JSON-formatted output to ELAN .eaf files.
 * @author Robert Fromont robert@fromont.net.nz
 */
@ProgramDescription(value="Converts JSON-formatted Whisper ASR files to ELAN files",arguments="file1.json file2.json ...")
public class WhisperToEaf extends Converter {
