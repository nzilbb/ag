...
import java.net.URL;
import nzilbb.converter.EafToTex;
import nzilbb.editpath.EditStep;
import nzilbb.editpath.MinimumEditPath;

public class TestEafToTex {
  ...
  @Test public void utterancesWithConventions() throws Exception {
    ...
    EafToTex converter = new EafToTex();
    // use inline annotation conventions
    converter.setSwitch("useConventions", "true");
    converter.convert(input);
    File actual = new File(dir, "elan.tex");
    File expected = new File(dir, "expected_elan.tex");
  ...
  @Test public void utterancesNoConventions() throws Exception {
    ...
    converter.convert(input);
    File actual = new File(dir, "elan.tex");
    File expected = new File(dir, "expected_elan_no_conventions.tex");
    String differences = diff(expected, actual);
    if (differences != null) {
      fail(differences);
    } else {
  ...
  @Test public void withAnnotations() throws Exception {
    ...
    converter.convert(input);
    File actual = new File(dir, "elan_annotations.tex");
    File expected = new File(dir, "expected_elan_annotations.tex");
    String differences = diff(expected, actual);
    if (differences != null) {
      fail(differences);
    } else {
  ...
  public static void main(String args[]) {
    org.junit.runner.JUnitCore.main("nzilbb.converter.TestEafToTex");
  }
}
