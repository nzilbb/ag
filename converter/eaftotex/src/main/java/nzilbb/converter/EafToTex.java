 ...
 */
@ProgramDescription(value="Converts ELAN .eaf files to LaTeX .tex files",arguments="file1.eaf file2.eaf ...")
public class EafToTex extends Converter {
  ...
  public EafToTex setIgnoreTiers(String newIgnoreTiers) { ignoreTiers = newIgnoreTiers; return this; }
  ...
  public EafToTex() {
    ...
    info = "All tiers will be interpreted as transcription of participant speech."
      ...
      +" command-line switch."
      +"\n "
      +"\nThe resulting .tex files each include a definition for a new '\turn' command which is"
      +" used throughout the trancript to format speaker turns; this can be customized directly"
      +" in the .tex files after conversion, or with the --texTurnCommand command line switch."
      +"\ne.g. \"--texTurnCommand=\\item[#1:] #2\""
      +"\n (#1 = Speaker ID, #2 = Turn Text)";
  } // end of constructor
   
  public static void main(String argv[]) {
    new EafToTex().mainRun(argv);
  }
  ...
  public String[] getLayersToSerialize() {
    String[] layers = { "utterance", "noise" };
    return layers;
  } // end of getLayersToSerialize()
      
  private static final long serialVersionUID = -1;
} // end of class EafToTex
