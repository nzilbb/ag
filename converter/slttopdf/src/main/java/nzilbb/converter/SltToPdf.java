 ...
 */
@ProgramDescription(value="Converts SALT transcripts to PDF documents",arguments="file1.slt file2.slt ...")
public class SltToPdf extends Converter {
