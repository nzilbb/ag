...
import java.net.URL;
import nzilbb.converter.SltToPdf;
import nzilbb.editpath.EditStep;
import nzilbb.editpath.MinimumEditPath;

public class TestSltToPdf {
  ...
  @Test public void conversion() throws Exception {
    ...
    SltToPdf converter = new SltToPdf();
    converter.convert(input);
    File actual = new File(dir, "salt.pdf");
  ...
  public static void main(String args[]) {
    org.junit.runner.JUnitCore.main("nzilbb.converter.TestSltToPdf");
  }
}
