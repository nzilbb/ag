...
public class TestSltToTex {
  
  @Test public void useConventions() throws Exception {
    File dir = getDir();
    File input = new File(dir, "salt.slt");
    SltToTex converter = new SltToTex();
    converter.setSwitch("parseInlineConventions", "true");
    converter.convert(input);
    File actual = new File(dir, "salt.tex");
    File expected = new File(dir, "expected_salt.tex");
  ...
  @Test public void ignoreConventions() throws Exception {
    ...
    converter.convert(input);
    File actual = new File(dir, "salt.tex");
    File expected = new File(dir, "expected_salt_no_conventions.tex");
    String differences = diff(expected, actual);
    if (differences != null) {
      fail(differences);
    } else {
  ...
  public static void main(String args[]) {
    org.junit.runner.JUnitCore.main("nzilbb.converter.TestSltToTex");
  }
}
