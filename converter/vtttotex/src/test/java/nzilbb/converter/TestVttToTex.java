...
import java.net.URL;
import nzilbb.converter.VttToTex;
import nzilbb.editpath.EditStep;
import nzilbb.editpath.MinimumEditPath;

public class TestVttToTex {
  ...
  @Test public void convert() throws Exception {
    ...
    VttToTex converter = new VttToTex();
    converter.convert(input);
    File actual = new File(dir, "webvtt.tex");
    File expected = new File(dir, "expected_webvtt.tex");
  ...
  public static void main(String args[]) {
    org.junit.runner.JUnitCore.main("nzilbb.converter.TestVttToTex");
  }
}
