...
public class TestWhisperToVtt {
  
  @Test public void webvtt() throws Exception {
    File dir = getDir();
    File input = new File(dir, "wordlist.json");
    WhisperToVtt converter = new WhisperToVtt();
    converter.convert(input);
    File actual = new File(dir, "wordlist.vtt");
    File expected = new File(dir, "expected_wordlist.vtt");
