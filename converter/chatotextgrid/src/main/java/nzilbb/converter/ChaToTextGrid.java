 ...
 */
@ProgramDescription(value="Converts CLAN CHAT transcripts to Praat TextGrids",arguments="file1.cha file2.cha ...")
public class ChaToTextGrid extends Converter {

  /**
   * Default constructor.
   */
  public ChaToTextGrid() {
    info = "Praat doesn't support any meta-data like @Date, @Location, etc."
      +" so all CHAT header meta-data is lost when converting to .TextGrid."
      +"\n "
  ...
  public static void main(String argv[]) {
    new ChaToTextGrid().mainRun(argv);
  }
