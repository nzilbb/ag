...
public class TestChaToTextGrid {
  
  @Test public void convert() throws Exception {
    File dir = getDir();
    File input = new File(dir, "clan.cha");
    ChaToTextGrid converter = new ChaToTextGrid();
    converter.convert(input);
    File actual = new File(dir, "clan.TextGrid");
    File expected = new File(dir, "expected_clan.TextGrid");
  ...
  public static void main(String args[]) {
    org.junit.runner.JUnitCore.main("nzilbb.converter.TestChaToTextGrid");
  }
}
