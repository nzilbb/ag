...
public class TestSltToVtt {
  
  @Test public void convert() throws Exception {
    File dir = getDir();
    File input = new File(dir, "salt.slt");
    SltToVtt converter = new SltToVtt();
    converter.convert(input);
    File actual = new File(dir, "salt.vtt");
    File expected = new File(dir, "expected_salt.vtt");
  ...
  public static void main(String args[]) {
    org.junit.runner.JUnitCore.main("nzilbb.converter.TestSltToVtt");
  }
}
