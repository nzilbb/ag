...
/**
 * Converts ELAN .eaf files to PDF documents.
 * @author Robert Fromont robert@fromont.net.nz
 */
@ProgramDescription(value="Converts ELAN .eaf files to PDF documents",arguments="file1.eaf file2.eaf ...")
public class EafToPdf extends Converter {
  ...
  public EafToPdf setIgnoreTiers(String newIgnoreTiers) { ignoreTiers = newIgnoreTiers; return this; }
