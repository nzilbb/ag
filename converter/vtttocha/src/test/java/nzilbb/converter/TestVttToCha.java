...
import java.net.URL;
import nzilbb.converter.VttToCha;
import nzilbb.editpath.EditStep;
import nzilbb.editpath.MinimumEditPath;

public class TestVttToCha {
  ...
  @Test public void convert() throws Exception {
    ...
    VttToCha converter = new VttToCha();
    converter.convert(input);
    File actual = new File(dir, "webvtt.cha");
    File expected = new File(dir, "expected_webvtt.cha");
  ...
  public static void main(String args[]) {
    org.junit.runner.JUnitCore.main("nzilbb.converter.TestVttToCha");
  }
}
