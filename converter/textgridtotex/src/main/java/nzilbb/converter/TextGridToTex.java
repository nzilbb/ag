 ...
 */
@ProgramDescription(value="Converts Praat TextGrids to LaTeX documents",arguments="file1.TextGrid file2.TextGrid ...")
public class TextGridToTex extends Converter {
  ...
  public TextGridToTex setIgnoreTiers(String newIgnoreTiers) { ignoreTiers = newIgnoreTiers; return this; }
  ...
  public static void main(String argv[]) {
    new TextGridToTex().mainRun(argv);
  }
