...
public class TestChaToEaf {
  
  @Test public void convert() throws Exception {
    File dir = getDir();
    File input = new File(dir, "clan.cha");
    ChaToEaf converter = new ChaToEaf();
    converter.convert(input);
    File actual = new File(dir, "clan.eaf");
    File expected = new File(dir, "expected_clan.eaf");
  ...
  public static void main(String args[]) {
    org.junit.runner.JUnitCore.main("nzilbb.converter.TestChaToEaf");
  }
}
