...
public class TestChaToVtt {
  
  @Test public void convert() throws Exception {
    File dir = getDir();
    File input = new File(dir, "clan.cha");
    ChaToVtt converter = new ChaToVtt();
    converter.convert(input);
    File actual = new File(dir, "clan.vtt");
    File expected = new File(dir, "expected_clan.vtt");
  ...
  public static void main(String args[]) {
    org.junit.runner.JUnitCore.main("nzilbb.converter.TestChaToVtt");
  }
}
