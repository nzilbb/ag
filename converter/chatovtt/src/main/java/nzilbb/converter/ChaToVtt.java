 ...
 */
@ProgramDescription(value="Converts CLAN CHAT transcripts to WebVTT subtitles",arguments="file1.cha file2.cha ...")
public class ChaToVtt extends Converter {
