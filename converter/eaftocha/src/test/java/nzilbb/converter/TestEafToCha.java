...
import java.net.URL;
import nzilbb.converter.EafToCha;
import nzilbb.editpath.EditStep;
import nzilbb.editpath.MinimumEditPath;

public class TestEafToCha {

  /** 
   * Test transcript-tiers-only .eaf file. 
   */
  @Test public void convert() throws Exception {
    File dir = getDir();
    File input = new File(dir, "mop03-2b.eaf");
    EafToCha converter = new EafToCha();
    converter.convert(input);
    File actual = new File(dir, "mop03-2b.cha");
    File expected = new File(dir, "expected_mop03-2b.cha");
  ...
  @Test public void withAnnotations() throws Exception {
    ...
    converter.convert(input);
    File actual = new File(dir, "elan_annotations.cha");
    File expected = new File(dir, "expected_elan_annotations.cha");
    String differences = diff(expected, actual);
    if (differences != null) {
      fail(differences);
    } else {
  ...
  public static void main(String args[]) {
    org.junit.runner.JUnitCore.main("nzilbb.converter.TestEafToCha");
  }
}
