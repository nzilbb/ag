...
public class TestEafToKaldi {

  /** Basic multi-file corpus serialization */
  @Test public void corpus() throws Exception {
    File dir = getDir();
    Vector<File> corpus = new Vector<File>();
    corpus.add(new File(dir, "t1.eaf"));
    corpus.add(new File(dir, "t2.eaf"));
    EafToKaldi converter = new EafToKaldi();
  ...
  public static void main(String args[]) {
    org.junit.runner.JUnitCore.main("nzilbb.converter.test.TestEafToKaldi");
  }
}
