...
/**
 * Converts Praat TextGrids to PDF documents.
 * @author Robert Fromont robert@fromont.net.nz
 */
@ProgramDescription(value="Converts Praat TextGrids to PDF documents",arguments="file1.TextGrid file2.TextGrid ...")
public class TextGridToPdf extends Converter {
  ...
  public TextGridToPdf setIgnoreTiers(String newIgnoreTiers) { ignoreTiers = newIgnoreTiers; return this; }
  ...
  public static void main(String argv[]) {
    new TextGridToPdf().mainRun(argv);
  }
