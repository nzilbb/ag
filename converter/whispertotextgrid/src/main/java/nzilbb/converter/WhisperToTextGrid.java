...
/**
 * Converts Whisper ASR's JSON-formatted output to Praat TextGrid.
 * @author Robert Fromont robert@fromont.net.nz
 */
@ProgramDescription(value="Converts JSON-formatted Whisper ASR files to Praat TextGrids",arguments="file1.json file2.json ...")
public class WhisperToTextGrid extends Converter {
  
  /**
   * Default constructor.
   */
  public WhisperToTextGrid() {
  } // end of constructor
  
  public static void main(String argv[]) {
    new WhisperToTextGrid().mainRun(argv);
  }
...
} // end of class WhisperToTextGrid
