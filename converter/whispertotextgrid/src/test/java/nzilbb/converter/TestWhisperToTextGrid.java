...
public class TestWhisperToTextGrid {
  
  @Test public void textgrid() throws Exception {
    File dir = getDir();
    File input = new File(dir, "wordlist.json");
    WhisperToTextGrid converter = new WhisperToTextGrid();
    converter.convert(input);
    File actual = new File(dir, "wordlist.TextGrid");
    File expected = new File(dir, "expected_wordlist.TextGrid");
  ...
  public static void main(String args[]) {
    org.junit.runner.JUnitCore.main("nzilbb.converter.TestTextGridSerialization");
  }
}
