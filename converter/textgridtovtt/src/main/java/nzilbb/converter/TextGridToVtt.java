...
/**
 * Converts Praat TextGrids to WebVTT subtitles.
 * @author Robert Fromont robert@fromont.net.nz
 */
@ProgramDescription(value="Converts Praat TextGrids to WebVTT subtitles",arguments="file1.TextGrid file2.TextGrid ...")
public class TextGridToVtt extends Converter {
  ...
  public TextGridToVtt setIgnoreTiers(String newIgnoreTiers) { ignoreTiers = newIgnoreTiers; return this; }
  ...
  public static void main(String argv[]) {
    new TextGridToVtt().mainRun(argv);
  }
