...
public class TestTrsToTex {
   
   @Test public void transcriber() throws Exception {
      File dir = getDir();
      File input = new File(dir, "transcriber.trs");
      TrsToTex converter = new TrsToTex();
      converter.convert(input);
      File actual = new File(dir, "transcriber.tex");
      File expected = new File(dir, "expected_transcriber.tex");
   ...
   public static void main(String args[]) {
      org.junit.runner.JUnitCore.main("nzilbb.converter.test.TestTrsToTex");
   }
}
