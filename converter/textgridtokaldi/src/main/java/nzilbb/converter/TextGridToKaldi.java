 ...
 */
@ProgramDescription(value="Converts Praat TextGrids to corpus input files for Kaldi",arguments="file1.TextGrid file2.TextGrid ...")
public class TextGridToKaldi extends Converter {
  ...
  public TextGridToKaldi setCleanOrthography(Boolean newCleanOrthography) { cleanOrthography = newCleanOrthography; return this; }
  ...
  public TextGridToKaldi setRemovalPattern(String newRemovalPattern) { removalPattern = newRemovalPattern; return this; }
  ...
  public TextGridToKaldi setIgnoreTiers(String newIgnoreTiers) { ignoreTiers = newIgnoreTiers; return this; }

  /**
   * Default constructor.
   */
  public TextGridToKaldi() {
  ...
  public static void main(String argv[]) {
    new TextGridToKaldi().mainRun(argv);
  }
