...
public class TestTextGridToKaldi {

  /** Basic multi-file corpus serialization */
  @Test public void corpus() throws Exception {
    File dir = getDir();
    Vector<File> corpus = new Vector<File>();
    corpus.add(new File(dir, "t1.TextGrid"));
    corpus.add(new File(dir, "t2.TextGrid"));
    TextGridToKaldi converter = new TextGridToKaldi();
    converter.setSwitch("useConventions","true");
    converter.setIgnoreTiers("word.*|turn");
    converter.convertBatch(corpus);
    String[] outputFiles = {
      "corpus.txt","segments","text","utt2spk","wav.scp","words.txt" };
    ...
    // spk2gender isn't generated because ELAN doesn't support participant meta-data
    File spk2gender = new File(dir, "spk2gender");
    assertFalse("spk2gender isn't generated", spk2gender.exists());
  }
  ...
  public static void main(String args[]) {
    org.junit.runner.JUnitCore.main("nzilbb.converter.test.TestTextGridToKaldi");
  }
}
