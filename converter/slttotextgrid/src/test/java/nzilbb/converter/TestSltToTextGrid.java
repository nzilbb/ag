...
public class TestSltToTextGrid {
  
  @Test public void useConventions() throws Exception {
    File dir = getDir();
    File input = new File(dir, "salt.slt");
    SltToTextGrid converter = new SltToTextGrid();
    converter.setSwitch("parseInlineConventions", "true");
    converter.convert(input);
    File actual = new File(dir, "salt.TextGrid");
    File expected = new File(dir, "expected_salt.TextGrid");
  ...
  @Test public void ignoreConventions() throws Exception {
    ...
    converter.convert(input);
    File actual = new File(dir, "salt.TextGrid");
    File expected = new File(dir, "expected_salt_no_conventions.TextGrid");
    String differences = diff(expected, actual);
    if (differences != null) {
      fail(differences);
    } else {
  ...
  public static void main(String args[]) {
    org.junit.runner.JUnitCore.main("nzilbb.converter.TestSltToTextGrid");
  }
}
