 ...
 */
@ProgramDescription(value="Converts SALT .slt transcripts to Praat .TextGrid files",arguments="file1.slt file2.slt ...")
public class SltToTextGrid extends Converter {
  ...
  public SltToTextGrid() {
    ...
    info = "Praat doesn't support meta-data like Dob, Doe, Ethnicity, etc."
      ...
      +" are not interpreted and appear as-is in the TextGrid."
      +" If you want them to be parse (i.e. annotations removed to yield more"
      +" standard orthography), use --parseInlineConventions";
  } // end of constructor
  
  public static void main(String argv[]) {
    new SltToTextGrid().mainRun(argv);
  }
